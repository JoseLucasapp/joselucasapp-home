...
const heroCopy = {
  ...
  "pt-BR": {
    tagline:
      "Engenheiro de Software Sênior focado em SaaS, pagamentos e automação com IA. Entrego sistemas confiáveis ponta a ponta (arquitetura → entrega) para times internacionais.",
